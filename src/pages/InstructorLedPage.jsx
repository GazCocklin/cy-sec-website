...
const InstructorLedPage = () => {
  ...
  const instructorLedModules = [
    ...
    { name: "CompTIA CySA+ (CS0-004)", features: ["5-Day Live Instructor-Led Bootcamp", "Official CompTIA eBook & Materials", "Hands-On Interactive Labs", "Exam Voucher Included", "Post-Course Instructor Support", "Peer Collaboration Opportunities"], ctaSource: "cysa_plus_instructor_led", logoUrl: "/logos/comptia-cysa-plus.svg" },
