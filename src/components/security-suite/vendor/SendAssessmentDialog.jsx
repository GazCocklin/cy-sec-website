...
const SendAssessmentDialog = ({ open, onOpenChange, vendor }) => {
  const { user } = useAuth();
  ...
  const handleSendAssessment = async () => {
    ...
    try {
      ...
      toast({ title: 'Assessment Sent!', description: `Questionnaire created for ${vendor.name}.` });
      onOpenChange(false);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Send New Assessment</DialogTitle>
          <DialogDescription>
            Create and send a new security questionnaire to {vendor?.name}.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSendAssessment} disabled={loading || loadingFrameworks}>
