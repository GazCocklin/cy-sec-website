...
const HybridCoursesPage = () => {
  ...
  const hybridModules = [
    ...
    { name: "CompTIA CySA+ (CS0-004)", price: "£1200 exc VAT", features: ["CertMaster Platform Access", "eBook & Study Materials", "Interactive Labs", "Exam Voucher Included", "Weekly Live Instructor Sessions", "Dedicated Tutor Support"], ctaSource: "cysa_plus_hybrid", logoUrl: "/logos/comptia-cysa-plus.svg" },
