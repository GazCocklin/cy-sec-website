    ...
    <div className="flex items-center gap-3 p-4 bg-[#F4F7FA] border border-[rgba(8,145,178,0.12)] rounded-xl hover:border-[rgba(8,145,178,0.3)] transition-colors">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex gap-2 flex-wrap mt-1.5">
          <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded bg-[rgba(14,95,138,0.1)] text-[#0E5F8A]">220-1202 · {lab.obj}</span>
...
const FAQ = [
  ...
  },
  {
    ...
    a: `For most people, no. The labs build the practical PBQ skill the exam tests, but A+ Core 2 has a heavy multiple-choice section covering operating systems, security concepts, software troubleshooting and operational procedures. Pair the labs with a strong MCQ resource — either the FortifyLearn Exam Engine or a third-party question bank — to cover both halves of the exam. The Exam Prep Bundle at ${formatPrice(priceOf('aplus_core2_prep_bundle'))} packages labs and Exam Engine together at a ${formatPrice(savingOf('aplus_core2_prep_bundle'))} saving.`,
  },
  {
...
export default function APlusCore2LabsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>CompTIA A+ Core 2 (220-1202) Practice Labs | FortifyLearn — Cy-Sec</title>
      ...
      <section className="relative overflow-hidden min-h-[500px] flex items-center">
        <div className="absolute inset-0">
          <img src="/screenshots/fl-sentryshield.png" alt="" className="w-full h-full object-cover object-center" />
        ...
        <div className="relative max-w-6xl mx-auto px-8 py-16 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-white mb-5" style={{ letterSpacing: '-1.5px', lineHeight: 1.1 }}>
              ...
              <span style={{ background: 'linear-gradient(90deg,#7DD3E8,#0891B2)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>OS. Security.</span><br />
      ...
      <section className="bg-white border-b border-[rgba(8,145,178,0.1)]">
        <div className="max-w-6xl mx-auto px-8 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="grid grid-cols-3 gap-3 lg:grid-cols-1 lg:gap-3">
            {[['10', 'Labs across 2 tiers'], ['220-1202', 'CompTIA exam code'], ['4', 'Domains covered']].map(([n, l]) => (
      ...
      <section className="bg-white py-14 px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex overflow-x-auto border-b-2 border-[rgba(8,145,178,0.15)] mb-8 gap-0">
            {[
              { id: 'p1', label: 'Foundation', meta: `5 labs · ${formatPrice(priceOf('aplus_core2_pack'))}` },
              { id: 'p2', label: 'Advanced',   meta: `5 labs · ${formatPrice(priceOf('aplus_core2_pack_2'))}` },
            ].map(t => (
