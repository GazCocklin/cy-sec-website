...
const allCourses = [
  ...
  { name: 'CompTIA CySA+', code: 'CS0-004', delivery: 'self-study', logo: 'comptia-cysa-plus', features: ['Access to CompTIA CertMaster', 'Access to CompTIA eBook', 'Access to CompTIA Labs', 'Exam Voucher Included'], ctaSource: 'cysa_plus_self_study' },
  ...
  { name: 'CompTIA CySA+', code: 'CS0-004', delivery: 'instructor-led', logo: 'comptia-cysa-plus', features: ['Live Instructor-Led Sessions', 'Interactive Q&A with Experts', 'Structured Class Schedule', 'All Self-Study Materials Included'], ctaSource: 'cysa_plus_instructor_led' },
  ...
  { name: 'CompTIA CySA+', code: 'CS0-004', delivery: 'hybrid', logo: 'comptia-cysa-plus', features: ['Self-Paced Learning with Instructor Support', 'On-Demand Videos & Live Workshops', 'Dedicated Mentor Access', 'All Self-Study Materials Included'], ctaSource: 'cysa_plus_hybrid' },
