...
const ProfessionalCertificationsPage = () => {
  ...
  const allCourses = [
    ...
    { name: "CompTIA CySA+ (CS0-004)", delivery: "self-study", features: ["Access to CompTIA CertMaster", "Access to CompTIA eBook", "Access to CompTIA Labs", "Exam Voucher Included"], ctaSource: "cysa_plus_self_study", logoUrl: "/logos/comptia-cysa-plus.svg" },
    ...
    { name: "CompTIA CySA+ (CS0-004)", delivery: "instructor-led", features: ["Live Instructor-Led Sessions", "Interactive Q&A with Experts", "Structured Class Schedule", "All Self-Study Materials Included"], ctaSource: "cysa_plus_instructor_led", logoUrl: "/logos/comptia-cysa-plus.svg" },
    ...
    { name: "CompTIA CySA+ (CS0-004)", delivery: "hybrid", features: ["Self-Paced Learning with Instructor Support", "On-Demand Videos & Live Workshops", "Dedicated Mentor Access", "All Self-Study Materials Included"], ctaSource: "cysa_plus_hybrid", logoUrl: "/logos/comptia-cysa-plus.svg" },
